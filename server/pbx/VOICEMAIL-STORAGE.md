...
The dedicated `/admin/voicemail` screen reports the schema and writable media
directory separately. Neither check proves the volume survives replacement or
that FreeSWITCH delivers completed messages.
