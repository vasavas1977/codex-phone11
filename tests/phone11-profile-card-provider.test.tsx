...
const m = vi.hoisted(() => ({ target: null as any, owner: 7 as number | undefined, path: "/chat/room", open: null as any, detail: null as any, close: null as any, dismissKeyboard: vi.fn() }));
...
vi.mock("../hooks/use-auth", () => ({ useAuth: () => ({ user: m.owner ? { id: m.owner } : null }) }));
...
function render(selectionOnly = false) { m.detail = null; return renderToStaticMarkup(<ProfileCardProvider selectionOnly={selectionOnly}><Child /></ProfileCardProvider>); }
