...
const mocks = vi.hoisted(() => ({
  state: {} as any, user: { id: 1 }, tenantId: "10", press: new Map<string, { press: () => unknown; disabled: boolean }>(), send: vi.fn(),
}));
...
vi.mock("react-native", () => ({
  ...
  FlatList: () => null, TextInput: () => null, Platform: { OS: "ios" },
...
vi.mock("../lib/chat/store", () => ({ useChatStore: () => mocks.state }));
import ChatRoom from "../app/chat/[id]";
beforeEach(() => {
  vi.clearAllMocks(); mocks.press.clear(); mocks.tenantId = "10";
  mocks.state = { userId: 1, workspace: { id: 10, name: "Work" }, channels: [{ id: "room", name: "Team", memberIds: [1, 2] }],
    drafts: { room: "Hello" }, messages: {}, roomErrors: {}, roomLoading: {}, hasMore: {}, sendMessage: mocks.send };
});
