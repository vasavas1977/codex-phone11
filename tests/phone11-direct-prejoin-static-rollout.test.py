#!/usr/bin/env python3
"""Pin and loader checks for the direct-prejoin static release entry point."""
...
WRAPPER = ROOT / "scripts/phone11-direct-prejoin-static-rollout.py"
CONTROLLER = ROOT / "scripts/phone11-static-portal-rollout.py"
SPEC = importlib.util.spec_from_file_location("direct_prejoin_static_rollout", WRAPPER)
...
class DirectPrejoinStaticRolloutTests(unittest.TestCase):
    def test_actual_release_pins_are_sealed_and_controller_loads(self):
        rollout.validate_pins()
        self.assertEqual(rollout.RELEASE_SHA, "47d48a697921fc20f7b638f6b00447072b9fe7b7")
        self.assertEqual(rollout.LIVE_RELEASE_SHA, "5e7bf01152ddab01a6a043c464e0f4749c71c55d")
