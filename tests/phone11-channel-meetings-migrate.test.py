"""Hermetic checks for the guarded channel-meeting migration operator."""
...
SCRIPT = ROOT / "scripts" / "phone11-channel-meetings-migrate.py"
SPEC = importlib.util.spec_from_file_location("phone11_channel_meetings_operator", SCRIPT)
...
class ChannelMeetingMigrationOperatorTests(unittest.TestCase):
