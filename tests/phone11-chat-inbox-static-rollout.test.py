#!/usr/bin/env python3
"""Pin and loader checks for the chat-inbox static release entry point."""
...
WRAPPER = ROOT / "scripts/phone11-chat-inbox-static-rollout.py"
CONTROLLER = ROOT / "scripts/phone11-static-portal-rollout.py"
SPEC = importlib.util.spec_from_file_location("chat_inbox_static_rollout", WRAPPER)
...
class ChatInboxStaticRolloutTests(unittest.TestCase):
    def test_actual_release_pins_are_sealed_and_controller_loads(self):
        rollout.validate_pins()
        self.assertEqual(rollout.RELEASE_SHA, "8b567c74c0c88d2d6ef285e9b0977ea797fc8ba1")
        self.assertEqual(rollout.LIVE_RELEASE_SHA, "47d48a697921fc20f7b638f6b00447072b9fe7b7")
