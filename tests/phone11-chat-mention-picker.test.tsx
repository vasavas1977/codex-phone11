...
vi.mock("react-native", () => ({ View: ({ children }: any) => createElement("div", null, children), Text: ({ children }: any) => createElement("span", null, children), TextInput: (props: any) => createElement("input", { placeholder: props.placeholder }), Pressable: ({ children }: any) => createElement("button", null, children), ScrollView: ({ children }: any) => createElement("div", null, children) }));
...
it("renders every current member in the scrollable picker, beyond the old twelve-item cutoff", () => {
  ...
  const html = renderToStaticMarkup(createElement(MentionPicker, { people, onPick: () => {} }));
