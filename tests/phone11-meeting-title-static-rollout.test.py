#!/usr/bin/env python3
"""Pin and loader checks for the meeting-title static release entry point."""
...
WRAPPER = ROOT / "scripts/phone11-meeting-title-static-rollout.py"
CONTROLLER = ROOT / "scripts/phone11-static-portal-rollout.py"
SPEC = importlib.util.spec_from_file_location("meeting_title_static_rollout", WRAPPER)
...
class MeetingTitleStaticRolloutTests(unittest.TestCase):
    def test_actual_release_pins_are_sealed_and_controller_loads(self):
        rollout.validate_pins()
        self.assertEqual(rollout.RELEASE_SHA, "5e7bf01152ddab01a6a043c464e0f4749c71c55d")
        self.assertEqual(rollout.LIVE_RELEASE_SHA, "0d13ddcba981c6a1dd04fae44dd1f11608f296ca")
