#!/usr/bin/env python3
"""Guarded route switch for the Phone11 chat-inbox API candidate.

Run as root on the VoIP host after a separately reviewed candidate is already
healthy on loopback port 3010. Prepare seals the exact before/after site files;
...
SCHEMA = "phone11-chat-inbox-release-route/v1"
SITE = Path("/etc/nginx/sites-enabled/phone11ai")
STATE_ROOT = Path("/var/lib/phone11-chat-inbox-release-route")
# Keep the same lock used by the previous Phone11 route operator.
LOCK = Path("/run/phone11-desktop-provisioning-route.lock")
ORIGINAL_SHA256 = "67017c07eca453b2856db5afc11d499cfc4a57822d17f8e5237a05ae2452d514"
CURRENT_CONTAINER = "cp11-api-candidate-meeting-title"
CURRENT_IMAGE = "sha256:c66d4e95e4177a75bb4a3c0c6a900de80c57f071b0b3d8d7daa45332404b2398"
CURRENT_BUNDLE = "870fdad722679a67575a57c27fee5131c2128aa75d97d201064588c76cb0292e"
TARGET_CONTAINER = "cp11-api-candidate-chat-inbox"
...
TARGET_BUILD = "chat-inbox-20260925"
CURRENT_PORT = 3009
TARGET_PORT = 3010
...
def check_predecessor() -> None:
    ...
    try:
        ...
        health = json.loads(raw)
        require(health.get("ok") is True and health.get("service") == "phone11-backend"
                and health.get("build") == "meeting-title-20260925"
