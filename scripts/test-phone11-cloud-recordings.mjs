...
try{
 ...
 for(const test of ['tests/phone11-cloud-recordings-postgres.test.ts','tests/phone11-route-cdr-postgres.test.ts','tests/phone11-outbound-correlation-postgres.test.ts']){
