...
try{
 ...
 const r=spawnSync(process.execPath,['node_modules/vitest/vitest.mjs','run','tests/phone11-cloud-recordings-postgres.test.ts'],{stdio:'inherit',env:{...process.env,PHONE11_CLOUD_RECORDING_TEST_SOCKET:socket,NODE_ENV:'test'}});process.exitCode=r.status??1;
