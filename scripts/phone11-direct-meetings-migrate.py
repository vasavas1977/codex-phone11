#!/usr/bin/env python3
"""Guarded Phone11 direct-meeting schema migration operator.
...
MANIFEST_SCHEMA = "phone11.direct-meetings-migration-manifest/v1"
INVENTORY_SCHEMA = "phone11.direct-meetings-migration-inventory/v1"
BACKUP_PROOF_SCHEMA = "phone11.direct-meetings-backup-proof/v1"
RESTORE_PROOF_SCHEMA = "phone11.direct-meetings-restore-proof/v1"
RECEIPT_SCHEMA = "phone11.direct-meetings-migration-journal/v1"
LOCK_PATH = Path("/run/lock/phone11-direct-meetings-migrate.lock")
RECEIPT_PATH = Path("/var/lib/phone11-direct-meetings/receipt.json")
    ...
    try:
        ...
        with operator_lock():
            if arguments.prepare:
                ...
                print("direct_meetings=PREPARE_READY apply=NOT_RUN")
                return 0
            ...
            print("direct_meetings=APPLIED receipt=WRITTEN")
            return 0
    except MigrationError as error:
        print("direct_meetings=BLOCKED stage=" + error.stage)
        return 1
    except (OSError, KeyboardInterrupt):
        print("direct_meetings=BLOCKED stage=operator")
        return 1
