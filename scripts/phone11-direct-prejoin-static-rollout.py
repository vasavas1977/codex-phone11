#!/usr/bin/env python3
"""Release-specific entry point for the Phone11 direct-prejoin web export.
...
its *candidate* pins with the sealed direct-prejoin export.  The underlying
...
RELEASE_SHA = "47d48a697921fc20f7b638f6b00447072b9fe7b7"
LIVE_RELEASE_SHA = "5e7bf01152ddab01a6a043c464e0f4749c71c55d"
RELEASE_EXPORT_MANIFEST_SHA256 = "b1c46c144c6f07bc085862bd1ed2ad09bc7fb8d2c4a808d5956e8728fc297cc9"
RELEASE_MARKER_SHA256 = "c33829a0eb0a416b29822a7e1425ed4b84a33f3c4607f07e1dabf9bc517a6c4b"
RELEASE_MAIN_JAVASCRIPT = "_expo/static/js/web/entry-288999297a1bf806e0b3125b17615d7d.js"
RELEASE_MAIN_JAVASCRIPT_SHA256 = "8628f13476eab8a58fab496edc79f054d9046c59256469a7eba0a0cb3a90a27d"
...
def main(argv: Sequence[str] | None = None) -> int:
    try:
        ...
        print(f"direct_prejoin_static_rollout=FAIL stage={error}", file=sys.stderr)
        return 1
