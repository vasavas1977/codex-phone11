...
Before each new offer, an independent transaction removes at most1000 expired terminal tombstones and1000 call rows whose setup expiry is older than24 hours and which have no live busy lease. Locked rows are skipped. This bounds ongoing growth during traffic; idle rows remain until a later offer or explicit `pruneExpired` maintenance run.
