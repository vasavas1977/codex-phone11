...
| During desktop meeting | Show named video tiles, a participant roster, gallery/speaker selection, audible output status, and persistent mute, camera, and leave controls. | Real join, media controls, named roster, and gallery/speaker layouts are implemented. Live admission and macOS/Windows media acceptance remain. |
