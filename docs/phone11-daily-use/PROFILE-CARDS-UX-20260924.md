...
Build 90 remains the previously installed device version; these new interactions require a subsequent signed build and handset validation. Browser/source tests do not establish native modal gestures, SIP continuity or physical-device acceptance. No backend deployment or provider action was performed.
