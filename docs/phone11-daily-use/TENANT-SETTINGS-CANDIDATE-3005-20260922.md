...
The focused Python suite preserves the eleven v1 checks and adds twelve v2 checks for fixed topology admission, 3003-to-3005 cloning, preservation of all four existing runtime slots, 3005 absence, v2 inventory selection/sealing, exact recovery routing, receipt separation, and the migrated schema-capability probe before any route change. An independent security review of the exact final source head is required before any production operation.
