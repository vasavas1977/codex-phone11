...
The latest signed artifact is **build 24**, the separate background-calling pilot, source `da4187d`. Its signed production APNs entitlement and pilot configuration are verified, but it is **not installed** and does not establish background-call acceptance. Build 23 remains installed. See [the signed pilot evidence](BACKGROUND-PILOT-BUILD-20260911.md#verified-signed-pilot-build-24).
