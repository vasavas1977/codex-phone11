...
A single synthetic unknown-address request under `example.invalid` returned HTTP 200 with the generic existence-neutral response. No real recipient was targeted by that check.
