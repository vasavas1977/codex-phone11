...
export function MentionPicker({ people, query, tenantId, loading = false, onPick }: { people: ChatPerson[]; query: string; tenantId?: number; loading?: boolean; onPick: (person: ChatPerson) => void }) {
